...
from fastapi import FastAPI, Request, Form, Depends, HTTPException, APIRouter, status
...
#@app.get("/delete_api_key")
#async def delete_api_key(request: Request, db: Session = Depends(database.get_db)):
#    return templates.TemplateResponse("delete_api_key.html", {"request": request})    
